...
class ModelOptimizer:
    ...
    def convert_sklearn_to_onnx(
        self, model_path: Path, output_path: Optional[Path] = None, initial_types: Optional[list] = None
    ) -> Path:
        """
    ...
    def quantize_onnx_model(self, model_path: Path, output_path: Optional[Path] = None) -> Path:
        ...
        try:
            ...
            quantize_dynamic(model_input=str(model_path), model_output=str(output_path), weight_type=QuantType.QInt8)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--models-dir", type=Path, default=None, help="Path to ml_models directory")
