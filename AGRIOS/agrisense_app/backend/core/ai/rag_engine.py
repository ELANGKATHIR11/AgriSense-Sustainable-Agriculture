...
class FarmerAssistant:
    ...
    def __init__(
        ...
        if not LANGCHAIN_AVAILABLE:
            raise ImportError(
                "LangChain dependencies not installed. " "Install with: pip install -r requirements-ai.txt"
            )
    ...
    def ask(
        ...
        if not self.vectorstore:
            raise RuntimeError("Knowledge base not initialized! Call ingest_knowledge_base() first.")
