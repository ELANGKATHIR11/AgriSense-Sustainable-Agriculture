        ...
        def decorator(func):
            ...
            async def wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    raise MLFailureError(f"ML prediction and all fallbacks failed for {func_name}")
...
async def rule_based_irrigation_recommendation(
    soil_moisture: float, temperature: float, humidity: float, crop_type: str
) -> Dict[str, Any]:
    """
...
async def rule_based_pest_risk(temperature: float, humidity: float, rainfall: float) -> Dict[str, Any]:
    """
