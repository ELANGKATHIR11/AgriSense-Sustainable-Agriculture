...
def setup_structured_logging(level: str = "INFO", enable_sampling: bool = False):
    """
    ...
    logging.info("Structured logging configured", extra={"log_level": level, "sampling_enabled": enable_sampling})
