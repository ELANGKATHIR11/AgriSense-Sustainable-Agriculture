...
def send_batch_notifications(self, notifications: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    try:
        safe_update_state(
            current_task, state="PROGRESS", meta={"progress": 10, "status": "Processing batch notifications"}
        )
...
def send_alert_notification(self, alert_data: Dict[str, Any], recipients: List[str]) -> Dict[str, Any]:
    ...
    try:
        safe_update_state(
            current_task, state="PROGRESS", meta={"progress": 10, "status": "Preparing alert notification"}
        )
        ...
        safe_update_state(
            current_task, state="PROGRESS", meta={"progress": 30, "status": "Sending alert notifications"}
        )
...
def send_maintenance_reminder(self, maintenance_data: Dict[str, Any], recipients: List[str]) -> Dict[str, Any]:
    ...
    try:
        safe_update_state(
            current_task, state="PROGRESS", meta={"progress": 20, "status": "Preparing maintenance reminder"}
        )
