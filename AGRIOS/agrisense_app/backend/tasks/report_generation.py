...
def generate_daily_report(self, date: Optional[str] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        safe_update_state(
            current_task, state="PROGRESS", meta={"progress": 10, "status": "Initializing report generation"}
        )
...
def generate_custom_report(self, config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        safe_update_state(
            current_task, state="PROGRESS", meta={"progress": 10, "status": "Parsing report configuration"}
        )
        ...
        safe_update_state(
            current_task, state="PROGRESS", meta={"progress": 20, "status": "Collecting custom data range"}
        )
