...
def system_health_check(self) -> Dict[str, Any]:
    ...
    try:
        ...
        safe_update_state(
            current_task, state="PROGRESS", meta={"progress": 50, "status": "Checking database connectivity"}
        )
...
def backup_database(self, backup_type: str = "incremental") -> Dict[str, Any]:
    ...
    try:
        safe_update_state(
            current_task, state="PROGRESS", meta={"progress": 10, "status": f"Starting {backup_type} backup"}
        )
...
def optimize_database(self) -> Dict[str, Any]:
    ...
    try:
        safe_update_state(
            current_task, state="PROGRESS", meta={"progress": 10, "status": "Starting database optimization"}
        )
