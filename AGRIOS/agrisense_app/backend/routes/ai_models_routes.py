...
def chatbot_enrich_answer(
    question: str, answer: str, crop_type: str = "unknown", language: str = "en"
) -> Dict[str, Any]:
    """
...
def chatbot_rerank_answers(question: str, answers: List[str], top_k: int = 5) -> Dict[str, Any]:
    """
...
def chatbot_contextual_response(messages: List[Dict[str, str]], system_prompt: Optional[str] = None) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        return {"response": response, "provider": "phi-llm", "message_count": len(messages)}
    except Exception as e:
...
def chatbot_validate_answer(question: str, answer: str) -> Dict[str, Any]:
    """
...
async def disease_detect_scold(image_base64: str, crop_type: str = "unknown") -> Dict[str, Any]:
    """
...
async def weed_detect_scold(image_base64: str, crop_type: str = "unknown") -> Dict[str, Any]:
    """
...
def models_health() -> Dict[str, Any]:
    ...
    return {"models": health, "overall": "healthy" if overall_healthy else "degraded"}
