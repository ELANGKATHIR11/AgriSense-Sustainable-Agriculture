...
async def list_crops(
    ...
    **Categories:**
    ...
    try:
        ...
        return CropListResponse(total_crops=len(crops), categories=categories, crops=crops)
...
async def get_disease_library(crop_name: str):
    ...
    try:
        ...
        return {"crop_name": crop_name, "total_diseases": len(diseases), "diseases": diseases}
    except HTTPException:
        raise
    except Exception as e:
...
async def get_weed_library(crop_name: str):
    ...
    try:
        ...
        return {"crop_name": crop_name, "total_weeds": len(weeds), "weeds": weeds}
    except HTTPException:
        raise
    except Exception as e:
    ...
    **Returns:**
    ...
    try:
        ...
        result = vlm_engine.analyze_disease(
            image_bytes, crop_name, expected_diseases=expected_list, include_cost_estimate=include_cost
        )
...
async def analyze_weeds(
    ...
    preferred_control: Optional[str] = Form(
        None, description="Preferred control method: chemical, organic, mechanical"
    ),
    include_cost: bool = Form(False, description="Include cost estimate"),
):
    """
    ...
    **Returns:**
    ...
    try:
        ...
        result = vlm_engine.analyze_comprehensive(
            plant_bytes, field_bytes, crop_name, growth_stage=growth_stage, include_cost_estimate=include_cost
        )
...
async def vlm_status():
    ...
    return {
        ...
        "crop_categories": ["cereal", "pulse", "oilseed", "vegetable", "fruit", "cash_crop", "spice"],
    }
