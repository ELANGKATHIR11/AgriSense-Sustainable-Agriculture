...
from .crop_database import Disease, get_crop_info, get_diseases_for_crop
...
class DiseaseDetector:
    ...
    def detect_disease(
        self, image_path: str, crop_name: str, expected_diseases: Optional[List[str]] = None
        ...
        try:
            ...
            # Detect symptoms
            symptoms_detected, severity, affected_percentage = self._detect_symptoms(image_cv, image_analysis)

            # Match disease based on symptoms
            disease_match, confidence = self._match_disease(crop_info, symptoms_detected, severity, expected_diseases)
    ...
    def _detect_symptoms(
        self, image: np.ndarray, image_analysis: Dict[str, Any]
    ...
    def batch_detect(self, image_paths: List[str], crop_name: str) -> List[DiseaseDetectionResult]:
        """
    ...
    def get_disease_summary(self, results: List[DiseaseDetectionResult]) -> Dict[str, Any]:
        """
