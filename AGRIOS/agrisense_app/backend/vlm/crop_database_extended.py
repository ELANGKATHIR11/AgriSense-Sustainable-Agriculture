...
from .crop_database import INDIAN_CROPS_DB, Crop, Disease, Weed
        ...
        "chickpea": Crop(
            ...
            common_diseases=[
                Disease(
                    ...
                    symptoms=[
                        "Drooping of leaves and petioles",
                        "Yellowing of leaves",
                        "Vascular browning",
                    ...
                    treatment=[
                        "No chemical treatment effective once disease appears",
                        "Remove infected plants",
                        "Soil solarization",
                    ],
                    prevention=[
                        "Use wilt-resistant varieties",
                        "Seed treatment with Trichoderma @ 4g/kg",
                        "Crop rotation with non-hosts for 3-4 years",
                        "Early sowing",
                    ],
                ...
                Disease(
                    ...
                    symptoms=[
                        "Circular gray spots with dark borders on leaves",
                        "Stem cankers",
                        "Pod lesions",
                        "Seedling death",
                    ],
            ...
            common_weeds=[
                Weed(
                    ...
                    characteristics=[
                        "Annual broadleaf",
                        "Rapid growth",
                        "Mealy white coating on leaves",
                        "High seed production",
                    ],
                    control_methods={
                        "chemical": [
                            "Pendimethalin 30% EC @ 1L/ha (pre-emergence)",
                            "Imazethapyr 10% SL @ 1L/ha (post-emergence)",
                        ],
        ...
        "pigeon_pea": Crop(
            ...
            common_diseases=[
                Disease(
                    ...
                    prevention=[
                        "Use resistant varieties like Pusa 992",
                        "Seed treatment with Trichoderma @ 4g/kg",
                        "Deep summer plowing",
                        "Crop rotation",
                    ],
                ...
                Disease(
                    ...
                    treatment=[
                        "Spray Dicofol 18.5% EC @ 2.5ml/L to control mites",
        ...
        "green_gram": Crop(
            ...
            common_diseases=[
                Disease(
                    ...
                    prevention=[
                        "Use resistant varieties like Pusa Vishal",
            ...
            common_diseases=[
                ...
                Disease(
                    ...
                    symptoms=[
                        ...
                        "Gray center with purple margins",
                        "Premature leaf drop",
        ...
        "groundnut": Crop(
            ...
            common_diseases=[
                Disease(
                    ...
                    treatment=[
                        "Spray Mancozeb 75% WP @ 2.5g/L",
                        "Apply Chlorothalonil @ 2g/L",
                        "3-4 sprays at 10-day intervals",
                    ],
                    prevention=[
                        "Use resistant varieties",
                        "Crop rotation",
                ...
                Disease(
                    ...
                    symptoms=[
                        "Wilting of plants",
                        "Brown lesions on stem near soil",
                        "White mycelial growth",
                        "Mustard seed-like sclerotia",
                    ],
                    causes=["Soil-borne fungus", "High soil moisture", "High temperature"],
                    treatment=[
                        "Spray Carbendazim @ 1g/L on stem base",
                        "Apply Trichoderma-enriched FYM",
                        "Metalaxyl soil drench",
                    ],
                    prevention=[
                        "Deep summer plowing",
                        "Crop rotation",
            ...
            common_weeds=[
                ...
                Weed(
                    ...
                    control_methods={
                        ...
                        "organic": [
                            "Hand pulling before flowering (wear gloves)",
                            "Cover cropping",
        ...
        "mustard": Crop(
            ...
            common_diseases=[
                Disease(
                    ...
                    symptoms=[
                        "Circular dark brown spots on leaves",
