...
CATALOG_DB = {
    "late blight": [
        ...
        {
            "name": "Azoxystrobin 23% SC (100ml)",
            "source": "BigHaat",
            "price_range": "₹450 - ₹510",
        },
        {
            "name": "Neem Oil 10000 PPM (1L)",
            "source": "Ugaoo",
            "price_range": "₹550 - ₹620",
        },
    ],
    "powdery mildew": [
        ...
        {
            "name": "Organic Potassium Bicarbonate (500g)",
            "source": "Indiamart",
            "price_range": "₹180 - ₹240",
        },
    ],
    ...
    "bacterial spot": [
        {
            "name": "Copper Hydroxide 53.8% DF (500g)",
            "source": "BigHaat",
            "price_range": "₹380 - ₹440",
        },
        {
            "name": "Streptocycline Bactericide (6g)",
            "source": "AgriBegri",
            "price_range": "₹45 - ₹55",
        },
        {
...
async def scrape_and_estimate_costs(disease_name: str) -> List[Dict[str, Any]]:
    ...
    if not matched_products:
        ...
        matched_products = [
            {
                "name": "Generic Neem Oil Pesticide (500ml)",
                "source": "Local Mandi",
                "price_range": "₹250 - ₹320",
            },
            {
                "name": "Systemic Fungicide (250g)",
                "source": "Indiamart",
                "price_range": "₹300 - ₹380",
            },
        ]
