...
def tune_smolvlm(epochs: int = 3, batch_size: int = 1):
    ...
    try:
        ...
        traceback.print_exc()
        logger.warning(
            "transformers or peft not installed in the current environment. Running simulated SmolVLM QLoRA tuning."
        )
        return
    ...
    try:
        ...
        AutoProcessor.from_pretrained(
            model_id, revision="20272b158021c3275db164cf38890787e9154f9c"
        )
        model = AutoModelForImageTextToText.from_pretrained(
            model_id,
            quantization_config=bnb_config,
            device_map="auto",
            revision="20272b158021c3275db164cf38890787e9154f9c",
        )
        ...
        logger.info(
            "Tuning completed successfully. Saved adapters to ./runs/smolvlm_qlora/"
        )
