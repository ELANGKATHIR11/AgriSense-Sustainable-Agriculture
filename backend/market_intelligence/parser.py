...
HEADER_MAPS = {
    ...
    "market": ["market", "mandi", "mandi name", "market name", "center", "bazaar", "apmc"],
    "crop": ["crop", "commodity", "crop name", "variety", "produce", "item"],
    "min_price": ["min price", "minimum", "min price (rs)", "minimum price", "min", "minimum rate"],
    "max_price": ["max price", "maximum", "max price (rs)", "maximum price", "max", "maximum rate"],
    "modal_price": ["modal price", "modal", "modal price (rs)", "modal_price", "price", "rate", "modal rate", "rsp", "msp"],
    "arrival": ["arrival", "arrivals", "quantity", "arrival (tonnes)", "arrival (q)", "volume"],
    "date": ["date", "reported date", "arrival date", "published date", "date of arrival", "updated"]
}
