...
from backend.market_intelligence.models import MarketPrice, GovernmentUpdate, AgricultureNews, MarketIntelligenceMetric
...
async def get_all_prices(
    ...
    sort_by: str = Query("timestamp", description="Sort field (price, timestamp, crop)"),
...
async def get_metrics(db: Session = Depends(get_db)):
    ...
    def get_metric_sum(name):
        res = db.query(func.sum(MarketIntelligenceMetric.value)).filter(
